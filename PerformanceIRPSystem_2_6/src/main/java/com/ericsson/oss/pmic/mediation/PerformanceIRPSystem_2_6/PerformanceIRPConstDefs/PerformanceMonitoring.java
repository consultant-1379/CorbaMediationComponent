...
public final class PerformanceMonitoring implements org.omg.CORBA.portable.IDLEntity {
  ...
  public com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.PerformanceIRPConstDefs.PerformanceMonitoringState state;
  ...
  public PerformanceMonitoring (final int performance_monitoring_id, 
                                ...
                                final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.PerformanceIRPConstDefs.PerformanceMonitoringState state) {
  ...
  public java.lang.String toString() {
    final java.lang.StringBuffer _ret = new java.lang.StringBuffer("struct com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.PerformanceIRPConstDefs.PerformanceMonitoring {");
    _ret.append("\n");
    ...
    _ret.append(",\n");
    _ret.append("com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.PerformanceIRPConstDefs.PerformanceMonitoringState state=");
    _ret.append(state);
    _ret.append("\n");
    _ret.append("}");
  ...
  public boolean equals (java.lang.Object o) {
    ...
    if (o instanceof com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.PerformanceIRPConstDefs.PerformanceMonitoring) {
      final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.PerformanceIRPConstDefs.PerformanceMonitoring obj = (com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.PerformanceIRPConstDefs.PerformanceMonitoring)o;
      boolean res = true;
      do {
