...
public final class FilteringNotSupportedException extends org.omg.CORBA.UserException {
  ...
  public FilteringNotSupportedException () {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.PerformanceIRPSystem.FilteringNotSupportedExceptionHelper.id());
  }

  public FilteringNotSupportedException (java.lang.String _reason) {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.PerformanceIRPSystem.FilteringNotSupportedExceptionHelper.id() + ' ' + _reason);
    
  }

  public java.lang.String toString () {
    final java.lang.StringBuffer _ret = new java.lang.StringBuffer("exception com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.PerformanceIRPSystem.FilteringNotSupportedException {");
    _ret.append("}");
