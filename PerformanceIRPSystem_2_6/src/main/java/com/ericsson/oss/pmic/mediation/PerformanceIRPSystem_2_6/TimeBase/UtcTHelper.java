...
public final class UtcTHelper {
  ...
  public static com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.TimeBase.UtcT read (final org.omg.CORBA.portable.InputStream _input) {
    final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.TimeBase.UtcT _result = new com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.TimeBase.UtcT();
    ...
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          ...
          members[0] = new org.omg.CORBA.StructMember("time", com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.TimeBase.TimeTHelper.type(), null);
          ...
          members[3] = new org.omg.CORBA.StructMember("tdf", com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_2_6.TimeBase.TdfTHelper.type(), null);
