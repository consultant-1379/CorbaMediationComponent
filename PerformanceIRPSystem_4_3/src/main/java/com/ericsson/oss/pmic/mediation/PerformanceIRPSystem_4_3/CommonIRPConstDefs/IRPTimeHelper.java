 ...
 * <b>IDL definition:</b>
 * <pre>
 * typedef com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.TimeBase.UtcT IRPTime;
 * </pre>
 */
public final class IRPTimeHelper {
  ...
  public static com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.TimeBase.UtcT read (final org.omg.CORBA.portable.InputStream _input) {
    com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.TimeBase.UtcT result;
    result = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.TimeBase.UtcTHelper.read(_input);
    return result;
  }
  ...
  public static void write (final org.omg.CORBA.portable.OutputStream _output, final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.TimeBase.UtcT _vis_value) {
    ...
    com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.TimeBase.UtcTHelper.write(_output, _vis_value);
  }
  ...
  public static void insert (final org.omg.CORBA.Any any, final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.TimeBase.UtcT _vis_value) {
    any.type(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.CommonIRPConstDefs.IRPTimeHelper.type());
  ...
  public static org.omg.CORBA.TypeCode type () {
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          org.omg.CORBA.TypeCode originalType = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.TimeBase.UtcTHelper.type();
