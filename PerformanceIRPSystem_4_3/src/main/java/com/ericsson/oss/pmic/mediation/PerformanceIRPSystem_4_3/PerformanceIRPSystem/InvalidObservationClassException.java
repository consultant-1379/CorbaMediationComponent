...
public final class InvalidObservationClassException extends org.omg.CORBA.UserException {
  ...
  public InvalidObservationClassException () {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.InvalidObservationClassExceptionHelper.id());
  }

  public InvalidObservationClassException (com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.ObservationClass[] observation_class_list) {
    this();
    this.observation_class_list = observation_class_list;
  }

  public InvalidObservationClassException (java.lang.String _reason, com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.ObservationClass[] observation_class_list) {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.InvalidObservationClassExceptionHelper.id() + ' ' + _reason);
    this.observation_class_list = observation_class_list;
  }

  public java.lang.String toString () {
    final java.lang.StringBuffer _ret = new java.lang.StringBuffer("exception com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.InvalidObservationClassException {");
    _ret.append("\n");
  ...
  public boolean equals (java.lang.Object o) {
    ...
    if (o instanceof com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.InvalidObservationClassException) {
      final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.InvalidObservationClassException obj = (com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.InvalidObservationClassException)o;
      boolean res = true;
      do {
