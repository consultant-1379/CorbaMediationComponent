...
public final class InvalidVersionNumberSyntaxException extends org.omg.CORBA.UserException {
  ...
  public InvalidVersionNumberSyntaxException () {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.InvalidVersionNumberSyntaxExceptionHelper.id());
  }

  public InvalidVersionNumberSyntaxException (java.lang.String _reason) {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.InvalidVersionNumberSyntaxExceptionHelper.id() + ' ' + _reason);
    
  }

  public java.lang.String toString () {
    final java.lang.StringBuffer _ret = new java.lang.StringBuffer("exception com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.InvalidVersionNumberSyntaxException {");
    _ret.append("}");
