...
public final class NoSuchIdException extends org.omg.CORBA.UserException {
  ...
  public NoSuchIdException () {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.NoSuchIdExceptionHelper.id());
  }

  public NoSuchIdException (java.lang.String _reason) {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.NoSuchIdExceptionHelper.id() + ' ' + _reason);
    
  }

  public java.lang.String toString () {
    final java.lang.StringBuffer _ret = new java.lang.StringBuffer("exception com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.NoSuchIdException {");
    _ret.append("}");
