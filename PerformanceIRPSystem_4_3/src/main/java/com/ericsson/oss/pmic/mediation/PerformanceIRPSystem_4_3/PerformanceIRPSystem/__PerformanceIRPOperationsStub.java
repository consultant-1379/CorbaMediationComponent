 ...
 * </pre>
 */
public class __PerformanceIRPOperationsStub extends com.inprise.vbroker.CORBA.portable.ObjectImpl implements com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem._PerformanceIRPOperations {
  final public static java.lang.Class _opsClass = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem._PerformanceIRPOperationsOperations.class;
  ...
  /**
   * <pre>
   *   com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.CommonIRPConstDefs.VersionNumberSet get_performance_IRP_version ();
   * </pre>
   */
    ...
    while (true) {
      if (!_is_local()) {
        ...
        try {
          ...
          _result = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.CommonIRPConstDefs.VersionNumberSetHelper.read(_input);
          return _result;
        }
        ...
        com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem._PerformanceIRPOperationsOperations _self = null;
        final org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("get_performance_IRP_version", _opsClass);
        if (_so == null) {
          continue;
        }
        try {
          _self = (com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem._PerformanceIRPOperationsOperations)_so.servant;
