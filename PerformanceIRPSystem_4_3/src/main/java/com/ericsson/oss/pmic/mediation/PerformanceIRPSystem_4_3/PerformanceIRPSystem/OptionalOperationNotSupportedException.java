...
public final class OptionalOperationNotSupportedException extends org.omg.CORBA.UserException {
  ...
  public OptionalOperationNotSupportedException () {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.OptionalOperationNotSupportedExceptionHelper.id());
  }

  public OptionalOperationNotSupportedException (java.lang.String _reason) {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.OptionalOperationNotSupportedExceptionHelper.id() + ' ' + _reason);
    
  }

  public java.lang.String toString () {
    final java.lang.StringBuffer _ret = new java.lang.StringBuffer("exception com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.OptionalOperationNotSupportedException {");
    _ret.append("}");
