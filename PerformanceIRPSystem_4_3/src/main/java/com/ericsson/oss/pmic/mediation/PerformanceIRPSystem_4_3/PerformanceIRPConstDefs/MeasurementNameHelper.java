 ...
 * <li> <b>IDL Name</b>      ::PerformanceIRPConstDefs::MeasurementName
 * <li> <b>Repository Id</b> IDL:PerformanceIRPConstDefs/MeasurementName:1.0
 * </ul>
 * <b>IDL definition:</b>
 * <pre>
 ...
 * </pre>
 */
public final class MeasurementNameHelper {
  ...
  public static void insert (final org.omg.CORBA.Any any, final java.lang.String _vis_value) {
    any.type(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.MeasurementNameHelper.type());
    ...
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          ...
          _type = _orb().create_alias_tc(id(), "MeasurementName", originalType);
        }
      }
    }
    return _type;
  ...
  public static java.lang.String id () {
    return "IDL:PerformanceIRPConstDefs/MeasurementName:1.0";
  }
}
