...
public final class ProcessingErrorException extends org.omg.CORBA.UserException {
  ...
  public ProcessingErrorException () {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.ProcessingErrorExceptionHelper.id());
  }
  ...
  public ProcessingErrorException (java.lang.String _reason, java.lang.String reason) {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.ProcessingErrorExceptionHelper.id() + ' ' + _reason);
    this.reason = reason;
  }

  public java.lang.String toString () {
    final java.lang.StringBuffer _ret = new java.lang.StringBuffer("exception com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.ProcessingErrorException {");
    _ret.append("\n");
  ...
  public boolean equals (java.lang.Object o) {
    ...
    if (o instanceof com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.ProcessingErrorException) {
      final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.ProcessingErrorException obj = (com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPSystem.ProcessingErrorException)o;
      boolean res = true;
      do {
