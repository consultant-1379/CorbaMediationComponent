 ...
 * <li> <b>IDL Name</b>      ::PerformanceIRPConstDefs::SamplingRate
 * <li> <b>Repository Id</b> IDL:PerformanceIRPConstDefs/SamplingRate:1.0
 * </ul>
 * <b>IDL definition:</b>
 * <pre>
 ...
 * </pre>
 */
public final class SamplingRateHelper {
  ...
  public static void insert (final org.omg.CORBA.Any any, final int _vis_value) {
    any.type(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.SamplingRateHelper.type());
    ...
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          ...
          _type = _orb().create_alias_tc(id(), "SamplingRate", originalType);
        }
      }
    }
    return _type;
  ...
  public static java.lang.String id () {
    return "IDL:PerformanceIRPConstDefs/SamplingRate:1.0";
  }
}
