...
public final class PerformanceEventHelper {
  ...
  public static com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEvent read (final org.omg.CORBA.portable.InputStream _input) {
    final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEvent _result = new com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEvent();
    _result.managed_object_class = _input.read_string();
    _result.observed_object_instance = _input.read_string();
    _result.event_category = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.EventCategoryHelper.read(_input);
    ...
    _result.attribute_name = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.InstanceListHelper.EMPTY_LIST;
    }
    ...
    _result.attribute_value = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.InstanceListHelper.EMPTY_LIST;
    }
    final int $length39 = _input.read_long();
    _result.suspect_flag = new com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.SuspectFlag[$length39];
    for (int $counter40 = 0; $counter40 < $length39; $counter40++) {
    _result.suspect_flag[$counter40] = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.SuspectFlagHelper.read(_input);
    }
    _result.event_time = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.TimeBase.UtcTHelper.read(_input);
    ...
    _result.additional_info_name = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.InstanceListHelper.EMPTY_LIST;
    }
    ...
    _result.additional_info_value = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.InstanceListHelper.EMPTY_LIST;
    }
    return _result;
  }

  public static void write (final org.omg.CORBA.portable.OutputStream _output, final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEvent _vis_value) {
    ...
    com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.EventCategoryHelper.write(_output, _vis_value.event_category);
    ...
    com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.SuspectFlagHelper.write(_output, _vis_value.suspect_flag[$counter47]);
    }
    if (_vis_value.event_time == null) {
      throw new org.omg.CORBA.BAD_PARAM("Invalid array length");
    }
    com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.TimeBase.UtcTHelper.write(_output, _vis_value.event_time);
  ...
  public static void insert (final org.omg.CORBA.Any any, final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEvent _vis_value) {
    any.insert_Streamable(new com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEventHolder(_vis_value));
  }

  public static com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEvent extract (final org.omg.CORBA.Any any) {
    com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEvent _vis_value;
    if (any instanceof com.inprise.vbroker.CORBA.Any) {
      com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEventHolder _vis_holder = new com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEventHolder();
      ((com.inprise.vbroker.CORBA.Any)any).extract_Streamable(_vis_holder);
      _vis_value = _vis_holder.value;
    }
    else {
      _vis_value = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.PerformanceEventHelper.read(any.create_input_stream());
    }
    return _vis_value;
  }
    ...
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          ...
          members[2] = new org.omg.CORBA.StructMember("event_category", com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.EventCategoryHelper.type(), null);
          ...
          members[6] = new org.omg.CORBA.StructMember("suspect_flag", _orb().create_sequence_tc(0, com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.PerformanceIRPConstDefs.SuspectFlagHelper.type()), null);
          members[7] = new org.omg.CORBA.StructMember("event_time", com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_4_3.CommonIRPConstDefs.IRPTimeHelper.type(), null);
