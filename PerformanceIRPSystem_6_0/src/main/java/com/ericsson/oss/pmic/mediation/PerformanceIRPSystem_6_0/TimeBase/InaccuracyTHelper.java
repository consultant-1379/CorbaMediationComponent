 ...
 * <b>IDL definition:</b>
 * <pre>
 * typedef com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.TimeBase.TimeT InaccuracyT;
 * </pre>
 */
public final class InaccuracyTHelper {
  ...
  public static void insert (final org.omg.CORBA.Any any, final long _vis_value) {
    any.type(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.TimeBase.InaccuracyTHelper.type());
    any.type(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.TimeBase.TimeTHelper.type());
  ...
  public static org.omg.CORBA.TypeCode type () {
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          org.omg.CORBA.TypeCode originalType = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.TimeBase.TimeTHelper.type();
