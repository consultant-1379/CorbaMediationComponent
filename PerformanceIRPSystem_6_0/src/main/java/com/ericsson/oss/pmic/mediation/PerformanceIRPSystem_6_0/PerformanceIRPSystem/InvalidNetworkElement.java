...
public final class InvalidNetworkElement extends org.omg.CORBA.UserException {
  ...
  public InvalidNetworkElement () {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPSystem.InvalidNetworkElementHelper.id());
  }
  ...
  public InvalidNetworkElement (java.lang.String _reason, java.lang.String[] ne_list) {
    super(com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPSystem.InvalidNetworkElementHelper.id() + ' ' + _reason);
    this.ne_list = ne_list;
  }

  public java.lang.String toString () {
    final java.lang.StringBuffer _ret = new java.lang.StringBuffer("exception com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPSystem.InvalidNetworkElement {");
    _ret.append("\n");
  ...
  public boolean equals (java.lang.Object o) {
    ...
    if (o instanceof com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPSystem.InvalidNetworkElement) {
      final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPSystem.InvalidNetworkElement obj = (com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPSystem.InvalidNetworkElement)o;
      boolean res = true;
      do {
