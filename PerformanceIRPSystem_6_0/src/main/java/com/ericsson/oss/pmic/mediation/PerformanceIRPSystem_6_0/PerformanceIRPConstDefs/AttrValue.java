...
public final class AttrValue implements org.omg.CORBA.portable.IDLEntity {
  ...
  private com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPConstDefs.AttrType _disc;
  boolean _defaultState = true;

  public AttrValue() {
  }

  public com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPConstDefs.AttrType discriminator() {
    return _disc;
  }
  ...
  public int i_attribute() {
    ...
    if (!_defaultState && ((_disc.value()) == com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPConstDefs.AttrType._INTEGER_ATTR)) {
  ...
  public void i_attribute(int _vis_value) {
    _disc = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPConstDefs.AttrType.INTEGER_ATTR;
  ...
  public double r_attribute() {
    ...
    if (!_defaultState && ((_disc.value()) == com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPConstDefs.AttrType._REAL_ATTR)) {
  ...
  public void r_attribute(double _vis_value) {
    _disc = com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPConstDefs.AttrType.REAL_ATTR;
  ...
  public java.lang.String toString() {
    final java.lang.StringBuffer _ret = new java.lang.StringBuffer("union com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPConstDefs.AttrValue {");
    if (!_defaultState) {
      switch (_disc.value()) {
  ...
  public boolean equals (java.lang.Object o) {
    ...
    if (o instanceof com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPConstDefs.AttrValue) {
      final com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPConstDefs.AttrValue obj = (com.ericsson.oss.pmic.mediation.PerformanceIRPSystem_6_0.PerformanceIRPConstDefs.AttrValue)o;
      boolean res = true;
